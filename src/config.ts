...
export const MachineConfigSchema = Schema.Struct({
  ...
  /** npm package name in the frontend that should link to the local sdk workspace */
  sdkClientPackage: Schema.optional(Schema.String),
});

export type MachineConfig = typeof MachineConfigSchema.Type;

/** Machine install config — not committed; see docs/runtime-layout.md */
const CONFIG_NAMES = [
